...
export default function TopicDetail() {
  ...
  const strategies = section ? getStrategiesBySection(section.id) : [];
  ...
  return (
    <div className="container-centered py-12 max-w-4xl">
      {/* Back Link */}
      <Link
        to="/syllabus"
        className="inline-flex items-center text-xs font-bold text-muted-foreground hover:text-primary mb-10 uppercase tracking-widest transition-all"
      >
      ...
      <div className="mb-12 border-b border-border pb-8">
        <div className="flex items-start justify-between gap-6">
          <div className="space-y-4">
            <h1 className="text-5xl font-heading font-bold text-foreground leading-tight">{topic.name}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-8">
          {strategies.length > 0 && (
            <div className="academic-card p-10 space-y-6">
              <h2 className="text-2xl font-heading font-bold flex items-center gap-3 text-foreground">
                <BookOpen className="h-6 w-6 text-primary" />
                Strategic Guidance
              </h2>
              <div className="prose prose-slate max-w-none text-muted-foreground font-sans leading-relaxed text-lg italic border-l-2 border-primary/20 pl-6">
        ...
        <div className="space-y-6">
          <div className="academic-card p-8 text-center bg-primary/5 border-primary/20">
            {questions.length > 0 ? (
              <div className="space-y-6">
                <div className="space-y-2">
                  <div className="text-4xl font-heading font-bold text-primary">{questions.length}</div>
